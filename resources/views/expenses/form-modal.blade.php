<x-form-modal id="expenseFormModal" submit="save">
    ...
    <x-slot name="content">
        <x-form.select2-dropdown-search label="Dossier" wire:model="expense.folder_id" routeName="getFolders" id="folder"
                             parentId="expenseFormModal" required placeholder="Rechercher le dossier"></x-form.select2-dropdown-search>
