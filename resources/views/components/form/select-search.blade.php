...
>
    <label for='{{ $name }}' class='form-label'>{{ $label }}: @if (isset($attributes['required'])) <span class="text-danger">*</span>@endif</label>
    ...
    >
        ...
        >
            ...
            <div class="relative z-30 w-full p-2 bg-white">
                <input type="search" x-model="search" x-on:click.prevent.stop="open=true" class="form-control">
            </div>
